                ...
                <ScrollView style={{ backgroundColor: '#636161' }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{ marginTop: 15 }}>
                            ...
                            <DescriptionMIN> Rua: {companyData?.headquarters?.address} </DescriptionMIN>
                            <DescriptionMIN> Cidade: {companyData?.headquarters?.city} </DescriptionMIN>
                            <DescriptionMIN> Estado: {companyData?.headquarters?.state} </DescriptionMIN>
                        </View>

                        <View style={{ marginTop: 15 }}>
                            <DescriptionTITLE> Dados de criação </DescriptionTITLE>
                            <DescriptionMIN> Data: {companyData?.founded} </DescriptionMIN>
                            <DescriptionMIN> Cidade: {companyData?.headquarters?.city} </DescriptionMIN>
                            <DescriptionMIN> Estado: {companyData?.headquarters?.state} </DescriptionMIN>
                        </View>
                    </View>
                    ...
                    <View style={{ marginTop: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                            ...
                            <View>
                                ...
                                <DescriptionTITLE> CEO:  </DescriptionTITLE>
                                <DescriptionMIN> {companyData?.founder} </DescriptionMIN>

                                <DescriptionTITLE> CTO:  </DescriptionTITLE>
                                <DescriptionMIN> {companyData?.founder} </DescriptionMIN>

                                <DescriptionTITLE> Fundador:  </DescriptionTITLE>
                                <DescriptionMIN> {companyData?.founder} </DescriptionMIN>
                            </View>

                            <View>
                                <DescriptionTITLE> COO:  </DescriptionTITLE>
                                <DescriptionMIN> {companyData?.coo} </DescriptionMIN>

                                <DescriptionTITLE> CTO Propulsor:  </DescriptionTITLE>
                                <DescriptionMIN> {companyData?.cto_propulsion} </DescriptionMIN>

                            </View>
                        </View>

                        <View style={{ alignItems: 'center' }}>
                            <DescriptionTITLE style={{fontSize: 25}}> Elon Musk: </DescriptionTITLE>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <ButtonRedirectetSocialMidia style={{ marginBottom: 10 }} onPress={() => redirectSocialMidia(companyData?.links.elon_twitter)}>
